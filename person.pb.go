...
type Person struct {
	...
	Followers            *SocialFollowers `protobuf:"bytes,3,opt,name=followers,proto3" json:"followers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *Person) GetFollowers() *SocialFollowers {
	if m != nil {
		return m.Followers
	}
	return nil
...
var fileDescriptor_4c9e10cf24b1156d = []byte{
	...
	0x10, 0x19, 0x28, 0x57, 0x29, 0x99, 0x8b, 0x2d, 0x00, 0x6c, 0xb8, 0x90, 0x10, 0x17, 0x4b, 0x5e,
	0x62, 0x2e, 0x44, 0x2b, 0x67, 0x10, 0x98, 0x2d, 0x24, 0xc0, 0xc5, 0x9c, 0x98, 0x9e, 0x0a, 0xd5,
	0x03, 0x62, 0x0a, 0x19, 0x73, 0x71, 0xa6, 0xc1, 0x2c, 0x94, 0x60, 0x56, 0x60, 0xd4, 0xe0, 0x36,
	0x12, 0xd5, 0x03, 0x39, 0x48, 0x0f, 0xcd, 0x35, 0x41, 0x08, 0x75, 0x49, 0x6c, 0x60, 0x87, 0x1b,
	0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x48, 0x03, 0x0c, 0x1c, 0xc8, 0x00, 0x00, 0x00,
}
